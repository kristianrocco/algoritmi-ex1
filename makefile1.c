...
# File sorgenti
MAIN_SRC = $(SRC_DIR)/main.c $(SRC_DIR)/sort.c
TEST_SRC = $(SRC_DIR)/test.c $(SRC_DIR)/sort.c
...
# Regola per creare main_ex1
$(MAIN_EXE): $(MAIN_OBJ)
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $^ $(LIBS)

# Regola per creare test_ex1
$(TEST_EXE): $(TEST_OBJ)
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $^ $(LIBS)
...
help:
	...
	@echo "  make all      - Compila i file eseguibili main_ex1 e test_ex1"
